...
public class TagoService {
	...
	private final String appKey = "fnyC%2Fb4wNr6W9EaP84Tyac4BVyrteRBwti2mUVVQ5hLu%2F9a2YrkUHdCJVQjexkbJed8YUswpg2ZchXc0SB08Hw%3D%3D";
...
//        return result;
	...
	public String getBusArrList(String citycode, String nodeid) throws IOException {
        ...
        JsonObject arrJson = JsonParser.parseString(sb.toString()).getAsJsonObject();
        
        JsonElement arrList = arrJson.get("response").getAsJsonObject()
        							 .get("body").getAsJsonObject()
        							 .get("items").getAsJsonObject()
        							 .get("item");
	...
	public String getNodeList(String citycode, String routeid) throws IOException {
		System.out.println("SERVICE  - getNodeList() 호출");
	...
	public String getBusLocList(String citycode, String routeid) throws IOException {
